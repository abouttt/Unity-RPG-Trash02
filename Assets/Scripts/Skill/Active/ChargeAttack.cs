...
public class ChargeAttack : ActiveSkill
{
    public ChargeAttack(ActiveSkillData data, int level = 0)
        : base(data, level)
    { }
    ...
    public override bool Use()
    {
        ...
        Player.Animator.SetInteger("SkillNumber", (int)SkillName.ChargeAttack);
